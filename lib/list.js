        ...
        inquirer.prompt([{
            ...
            if (action === 'VIEW_DEPARTMENTS') {
                ...
                },
                {
                    ...
                    const params = [first_name, last_name, +data.role_id, +data.manager_id];
                    pool.query(sql, params, (err, { rows }) => {
                        console.log('\n');
                        console.log('Added Successfully')
                        console.log('\n');
            ...
            } else if (action === 'DELETE_EMPLOYEES') {
                inquirer.prompt([{
                    type: 'confirm',
                    name: 'id',
                    message: 'Do you want to delete employee?'
                }]).then((data) => {
                    const sql = `UPDATE employee SET id = $1 ;`;
            ...
            } else if (action === 'DELETE_DEPARTMENTS') {
                inquirer.prompt([{
                    type: 'confirm',
                    name: 'id',
